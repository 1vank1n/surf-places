...
import 'package:places/data/redux/filters/reducers.dart';
import 'package:places/data/redux/place_create/actions.dart';
import 'package:places/data/redux/place_create/reducers.dart';
import 'package:places/data/redux/place_detail/actions.dart';
import 'package:places/data/redux/place_detail/reducers.dart';
import 'package:places/data/redux/place_list/actions.dart';
import 'package:places/data/redux/place_list/reducers.dart';
import 'package:places/data/redux/place_search/actions.dart';
import 'package:places/data/redux/place_search/reducers.dart';
