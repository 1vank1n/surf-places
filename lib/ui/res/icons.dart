...
const String iconClose = 'res/icons/icon-close.svg';
...
// BottomNavigationBar
const String iconHeart = 'res/icons/icon-heart.svg';
const String iconHeartFill = 'res/icons/icon-heart-fill.svg';
const String iconList = 'res/icons/icon-list.svg';
const String iconListFill = 'res/icons/icon-list-fill.svg';
const String iconMap = 'res/icons/icon-map.svg';
const String iconMapFill = 'res/icons/icon-map-fill.svg';
const String iconSettings = 'res/icons/icon-settings.svg';
const String iconSettingsFill = 'res/icons/icon-settings-fill.svg';
